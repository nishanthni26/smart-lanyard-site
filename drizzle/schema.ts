...
/** Public contact details submitted through the Smart Lanyard demo request form. */
export const demoRequests = mysqlTable("demo_requests", {
  id: int("id").autoincrement().primaryKey(),
  fullName: varchar("full_name", { length: 160 }).notNull(),
  workEmail: varchar("work_email", { length: 320 }).notNull(),
  organisation: varchar("organisation", { length: 160 }).notNull(),
  organisationType: varchar("organisation_type", { length: 64 }).notNull(),
