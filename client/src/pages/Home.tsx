...
export default function Home() {
  ...
  return <MotionConfig reducedMotion="user"><main className="friendly-site">
    <header className="friendly-nav"><button className="friendly-brand" onClick={() => scrollTo("#top")} aria-label="Smart Lanyard home"><img src={brandMark} alt="" /><span>SMART<br />LANYARD</span></button><nav aria-label="Primary navigation"><button onClick={() => scrollTo("#product")}>The product</button><button onClick={() => scrollTo("#solutions")}>Solutions</button><button onClick={() => scrollTo("#platform")}>Platform</button><a href="/faq">FAQ</a></nav><button className="friendly-nav-cta" onClick={requestPilot}>Book a pilot <ArrowRight /></button></header>
